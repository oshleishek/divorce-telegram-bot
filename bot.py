...
Розрахунок займе <b>2 хвилини</b> і він абсолютно <b>безкоштовний</b>.
...
Наша перша задача - дати клієнту <b>чіткий, покроковий план.</b>
...
def get_personalized_offer(first_name, segment_name):
    """Генерує персоналізований оффер (Без '3 слотів')"""
...
Але для тих, хто пройшов цей тест, ціна — <b>всього 990 грн.</b>
Ця спеціальна пропозиція **діє лише до кінця цього тижня**.
...
<i>Тобто консультація фактично безкоштовна, якщо ви станете клієнтом.</i>
"""
