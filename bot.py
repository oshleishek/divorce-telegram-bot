...
# Результати (Поглиблені)
SEGMENT_MESSAGES = {
    # А1/А2 (Прості)
    'A1': "⚡️ <b>Сценарій: Експрес (Без дітей та майна)</b>\n\nІдеальна ситуація для швидкого результату.\n\n💰 <b>Бюджет:</b> 5 500 — 7 500 грн\n⏱ <b>Строки:</b> 2-3 місяці\n\n<b>Що робити:</b>\nШвидкий позов без зайвих клопотань. Головне — контроль канцелярії суду." + DISCLAIMER_TEXT,
    'A2': "✅ <b>Сценарій: Стандарт (Без дітей та майна)</b>\n\nКласичне розлучення. Ризиків мінімум.\n\n💰 <b>Бюджет:</b> 4 500 — 6 500 грн\n⏱ <b>Строки:</b> 3-4 місяці\n\n<b>Порада:</b>\nНе переплачуйте. Тут не потрібен топ-адвокат, достатньо надійного виконавця." + DISCLAIMER_TEXT,
    
    # B1 (Діти + Конфлікт)
    'B1': "🛡 <b>Сценарій: Судовий спір за дітей</b>\n\nЦе складна категорія. Потрібна стратегія.\n\n💰 <b>Бюджет:</b> 14 000 — 22 000 грн\n⏱ <b>Строки:</b> 5-8 місяців\n\n<b>Ключове:</b>\nОргани опіки, графік зустрічей, аліменти. Вам потрібен адвокат-психолог, який захистить дитину від стресу." + DISCLAIMER_TEXT,
    
    # B2 (Діти + Згода)
    'B2': "👨‍👩‍👧 <b>Сценарій: Мирне розлучення з дітьми</b>\n\nВи молодці, що домовилися. Це економить нерви.\n\n💰 <b>Бюджет:</b> 8 000 — 12 000 грн\n⏱ <b>Строки:</b> 3-4 місяці\n\n<b>Нюанс:</b>\nСума включає послуги адвоката та підготовку договору. Окремо може знадобитися оплата нотаріуса (якщо суд вимагатиме нотаріальний договір), але ми знаємо, як оптимізувати ці витрати." + DISCLAIMER_TEXT,
    
    # C1 (Майно + Конфлікт)
    'C1': "💼 <b>Сценарій: Складний поділ майна</b>\n\nВисокі ставки. Потрібен захист активів.\n\n💰 <b>Бюджет:</b> 25 000 — 50 000+ грн\n⏱ <b>Строки:</b> 8-16 місяців\n\n<b>Стратегія:</b>\nАрешт майна, оцінка, боротьба за частки. Тут економія на юристі може коштувати половини квартири." + DISCLAIMER_TEXT,
    
    # C2 (Майно + Згода) - НОВИЙ СЕГМЕНТ
    'C2_PEACE': "🤝 <b>Сценарій: Юридичне оформлення поділу майна</b>\n\nВи домовилися — це супер. Залишилося закріпити це юридично.\n\n💰 <b>Бюджет:</b> 10 000 — 16 000 грн\n⏱ <b>Строки:</b> 3-5 місяців\n\n<b>Варіанти:</b>\nАбо нотаріус (швидко, але дорого через податки), або судова мирова угода (довше, але дешевше). Ми прорахуємо вигідніший шлях." + DISCLAIMER_TEXT,
    
    # C3 (Майно + Конфлікт, без дітей)
    'C3_WAR': "💰 <b>Сценарій: Судовий поділ майна (без дітей)</b>\n\nЧиста математика та боротьба за активи.\n\n💰 <b>Бюджет:</b> 18 000 — 30 000 грн\n⏱ <b>Строки:</b> 6-10 місяців\n\n<b>Задача:</b>\nЧесна оцінка та справедливий поділ (включно з боргами/кредитами)." + DISCLAIMER_TEXT,

    # D (За кордоном)
    'D1': "🌍 <b>Сценарій: Міжнародний VIP</b>\n\nПовний супровід без вашої участі.\n\n💰 <b>Бюджет:</b> 18 000 — 26 000 грн\n⏱ <b>Строки:</b> 4-5 місяців\n\n<b>Перевага:</b>\nDigital-адвокат: все через Електронний суд та відеозв'язок." + DISCLAIMER_TEXT,
    'D2': "🌍 <b>Сценарій: Міжнародний Стандарт</b>\n\nДистанційне розлучення.\n\n💰 <b>Бюджет:</b> 14 000 — 20 000 грн\n⏱ <b>Строки:</b> 4-6 місяців\n\n<b>Як це працює:</b>\nМи організуємо процес так, що вам не доведеться приїжджати в Україну." + DISCLAIMER_TEXT,
    
    # E (Розшук)
    'E1': "🔍 <b>Сценарій: Без відомої адреси</b>\n\nПроцедурна складність.\n\n💰 <b>Бюджет:</b> 12 000 — 16 000 грн\n⏱ <b>Строки:</b> 5-7 місяців\n\n<b>Рішення:</b>\nРозлучення через оголошення на сайті суду." + DISCLAIMER_TEXT,
    'E2': "🔍 <b>Сценарій: Розшук / Саботаж</b>\n\nВідповідач ховається.\n\n💰 <b>Бюджет:</b> 16 000 — 24 000 грн\n⏱ <b>Строки:</b> 6-9 місяців\n\n<b>Тактика:</b>\nОтримання заочного рішення суду незважаючи на протидію." + DISCLAIMER_TEXT
}
...
async def send_result(update: Update, context: ContextTypes.DEFAULT_TYPE, segment, segment_name, cost, time):
    """Відправляє результат + Дорожню карту"""
    ...
    # Дорожня карта (Hook перед оплатою)
    roadmap = ""
    if 'D' in segment: 
        roadmap = "📋 <b>Чек-лист для старту (Дистанційно):</b>\n1. Електронний ключ (КЕП).\n2. Довіреність з Апостилем (обов'язково!).\n3. Реєстрація в EasyCon (відеосуд).\n\n⚠️ <b>Ризик:</b> Без правильної адреси відповідача суд зупинить справу."
    elif 'B2' in segment or 'C2' in segment: 
        roadmap = "📋 <b>Чек-лист (Мирний шлях):</b>\n1. Спільна заява.\n2. Оригінал свідоцтва про шлюб.\n3. <b>Нотаріальний договір</b> (ст. 109 СК).\n\n⚠️ <b>Пастка:</b> Без нотаріального договору суд ПОВЕРНЕ заяву."
    elif 'C' in segment: 
        roadmap = "📋 <b>Чек-лист (Майно):</b>\n1. Документи на все майно.\n2. Оцінка вартості.\n3. Квитанція (1% збору).\n\n⚠️ <b>Порада:</b> Подавайте на АРЕШТ майна разом з позовом, щоб його не продали."
    else: 
        roadmap = "📋 <b>Чек-лист (Стандарт):</b>\n1. Позовна заява (2 шт).\n2. Оригінал свідоцтва.\n3. Квитанція 1211 грн.\n\n⚠️ <b>Ризик:</b> Помилка в підсудності затягне справу на 2 місяці."
    
    await context.bot.send_message(chat_id=update.effective_chat.id, text=roadmap, parse_mode='HTML')
