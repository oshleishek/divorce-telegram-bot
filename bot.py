...
# =====================================================
# ЕКСПЕРТНІ КОМЕНТАРІ (ДОВІРА + ПІДТРИМКА)
# =====================================================
...
MINI_CASES = {
    ...
    'yes_children_no_consent': [
        """
<i>Розумію вашу тривогу. Коли другий з подружжя проти, це створює найбільший стрес.

Але хочу вас заспокоїти: <b>відсутність згоди не є перешкодою для розлучення.</b> Ніхто не може змусити вас бути у шлюбі проти волі.

Наша головна мета в такій ситуації — захистити інтереси дітей та мінімізувати їхній стрес від процесу. Ми беремо всі переговори на себе.</i>
"""
    ],
    
    # Ситуация: Все мирно (Мирный договор)
    'no_children_yes_consent': [
        """
<i>Чудово, що ви досягли згоди. Це збереже вам купу часу та нервів.

У таких випадках наше завдання — <b>зробити все максимально швидко і "непомітно" для вас.</b> 

Ми підготуємо документи так, щоб вас розлучили з першого разу, без повернень на доопрацювання та зайвої бюрократії.</i>
"""
    ],
    ...
    'yes_property': [
        """
<i>Розділ майна — це завжди про фінансову безпеку вашого майбутнього. Тут важливо відкинути емоції і діяти прагматично.

Часто люди думають, що все ділиться автоматично 50/50, але є багато нюансів (особисті вкладення, подарунки, борги).

Ми допоможемо розібратися, <b>що належить саме вам по закону</b>, щоб ви не втратили свої активи.</i>
"""
    ],
    ...
    'abroad': [
        """
<i>Відстань зараз не є проблемою. Вам <b>не потрібно витрачати кошти та час на приїзд в Україну</b> заради судів.

Ми спеціалізуємося на дистанційних процесах. Всю роботу з документами та судами ми беремо на себе. Ви зможете контролювати процес через месенджер, займаючись своїми справами за кордоном.</i>
"""
    ],
    
    # Ситуация: Неизвестно где / Розыск
    'unknown_location': [
        """
<i>Не хвилюйтеся. Те, що ви не знаєте адреси або чоловік/дружина не виходить на зв'язок — це не глухий кут.

Закон дозволяє розлучення "за відсутності" через спеціальну процедуру. Так, це вимагає правильного оформлення документів для суду, але <b>ви гарантовано отримаєте розлучення</b>, навіть якщо друга сторона так і не з'явиться.</i>
"""
    ],
    ...
    'default': [
        """
<i>Розумію, процес розлучення часто здається складним та заплутаним.

Але насправді, коли є <b>чіткий юридичний план</b>, 90% страхів зникають. Ви будете чітко розуміти кожен наступний крок, а всю складну юридичну роботу ми візьмемо на себе.</i>
"""
    ]
}
