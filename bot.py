...
# 📝 ТЕКСТ: Питання 6 (ПОКРАЩЕНО, СИЛЬНА РАМКА - БЕЗ ЖИРНОГО)
TEXT_Q6_PHONE = """
✅ Дякую за відповіді!

Останнє питання (6 з 6)

Поділіться номером телефону, щоб отримати детальний розрахунок.

Це абсолютно конфіденційно і ні до чого вас не зобов'язує. Ми не передаємо дані третім особам і не розсилаємо спам.

<i>Натисніть кнопку нижче ⬇️</i>
"""

# =====================================================
# ДЕТАЛЬНІ МИНІ-КЕЙСИ (ВИПРАВЛЕНА ВЕРСІЯ, від 3-го особи)
# =====================================================

MINI_CASES = {
    # Для тих, у кого Є ДІТИ + НЕМАЄ ЗГОДИ (ІНКЛЮЗИВНИЙ КЕЙС)
    'yes_children_no_consent': [
        """
━━━━━━━━━━━━━━━━━
💬 <b>Кейс: "Захист дитини" (Харків, 34 роки)</b>

<i>До нас звернулася клієнтка (назвемо її Марина). Її чоловік був категорично проти розлучення і погрожував забрати дитину. З іншого боку, він боявся, що Марина заборонить йому бачитися з сином.

Наша робота полягала в тому, щоб захистити інтереси дитини. Ми зібрали докази того, що матір завжди дбала про сина...

✅ <b>Результат:</b> Суд залишив дитину з матір'ю, АЛЕ ми також розробили **чіткий і справедливий графік зустрічей для батька.** Ми захистили інтереси і матері, і дитини, і батька.</i>
━━━━━━━━━━━━━━━━━
""",
        """
━━━━━━━━━━━━━━━━━
💬 <b>Кейс: "Права батька" (Дніпро, 38 років)</b>

<i>До нас звернувся клієнт (Олег). Дружина подала на розлучення і хотіла обмежити його спілкування з сином, мотивуючи це "поганим впливом".

Наша задача була довести, що Олег - хороший, люблячий батько. Ми зібрали свідчення від вчителів та сусідів, надали докази його участі у вихованні.

✅ <b>Результат:</b> Суд задовольнив позов дружини про розлучення, але **повністю відхилив її вимоги про обмеження спілкування.** Ми зберегли для батька повноцінну участь у житті дитини.</i>
━━━━━━━━━━━━━━━━━
"""
    ],
    
    # Для тих, у кого НЕМАЄ ДІТЕЙ + Є ЗГОДА (ПОЗИЦІЯ СЕРВІСУ)
    'no_children_yes_consent': [
        """
━━━━━━━━━━━━━━━━━
💬 <b>Кейс: "Розлучення під ключ" (Київ, 33 роки)</b>

<i>До нас звернулася клієнтка (Оксана) та її чоловік. Вони розійшлися мирно, і їх головний запит - "щоб все пройшло без нашої участі, без стресу і судів".

Це був класичний випадок "розлучення під ключ". Ми взяли на себе 100% паперової роботи та представництва.

✅ <b>Результат:</b> Розлучення за 2.5 місяці. **Клієнти жодного разу не були в суді.** Вони просто отримали готове рішення поштою.</i>
━━━━━━━━━━━━━━━━━
""",
        """
━━━━━━━━━━━━━━━━━
💬 <b>Кейс: "Економія часу" (Одеса, 29 років)</b>

<i>Клієнт (Андрій) хотів розлучитися, але боявся бюрократії: "я нічого в цьому не розумію, не маю часу".

Ми підготували всі документи за 1 робочий день і подали позов до суду.

✅ <b>Результат:</b> Розлучення за 3 місяці. Головна цінність для клієнта - він витратив на весь процес **сумарно не більше 1 години** свого особистого часу.</i>
━━━━━━━━━━━━━━━━━
"""
    ],
    
    # Для тих, у кого Є МАЙНО (ІНКЛЮЗИВНИЙ КЕЙС)
    'yes_property': [
        """
━━━━━━━━━━━━━━━━━
💬 <b>Кейс: "Справедливий розділ" (Київ, 40+ років)</b>

<i>Це був складний випадок. Клієнтка (Ірина) вклала в квартиру особисті кошти (подарунок батьків) і боялася розділу 50/50. А її чоловік (Сергій) боявся за долю у своєму бізнесі (ФОП).

Наша задача була - не просто "розділити 50/50", а зробити це справедливо.

✅ <b>Результат:</b> Ми довели вкладення Ірини (вона отримала 65% квартири) і **одночасно захистили бізнес Сергія** від розділу як спільного майна. Обидві сторони отримали справедливе рішення.</i>
━━━━━━━━━━━━━━━━━
"""
    ],
    
    # Для тих, хто ЗА КОРДОНОМ (ЗБАЛАНСОВАНО)
    'abroad': [
        """
━━━━━━━━━━━━━━━━━
💬 <b>Кейс: "Онлайн-розлучення" (Німеччина, 30 років)</b>

<i>Клієнтка (Яна) виїхала до Німеччини з дітьми, а чоловік залишився в Україні. Вона думала, що доведеться повертатися.

Ми організували все дистанційно: Яна оформила довіреність в консульстві і надіслала документи поштою.

✅ <b>Результат:</b> Розлучення за 4 місяці **повністю онлайн**, без жодного приїзду клієнтки в Україну.</i>
━━━━━━━━━━━━━━━━━
""",
        """
━━━━━━━━━━━━━━━━━
💬 <b>Кейс: "Розлучення з-за кордону" (Польща, 36 років)</b>

<i>Клієнт (Максим) працює в Познані, дружина в Україні (згодна на розлучення). Він не міг покинути роботу, щоб їздити на засідання.

Ми зв'язалися з ним по WhatsApp, отримали скан-копії документів і оформили довіреность через консула.

✅ <b>Результат:</b> Розлучення за 4 місяці. Максим **жодного разу не приїжджав** і не відривався від роботи.</i>
━━━━━━━━━━━━━━━━━
"""
    ],
    
    # Для тих, хто НЕ ЗНАЄ ДЕ СУПРУГ (ЗБАЛАНСОВАНО)
    'unknown_location': [
        """
━━━━━━━━━━━━━━━━━
💬 <b>Кейс: "Без адреси" (Запоріжжя, 29 років)</b>

<i>Чоловік клієнтки (Олени) поїхав на заробітки і пропав. Телефон не бере, адреси невідомо.

Ми пояснили, що це не перешкода. Закон дозволяє розлучення "за відсутності" через оголошення на сайті суду.

✅ <b>Результат:</b> Розлучення через 6 місяців. Чоловік так і не з'явився, але процес відбувся **повністю легально без нього.**</i>
━━━━━━━━━━━━━━━━━
""",
        """
━━━━━━━━━━━━━━━━━
💬 <b>Кейс: "Розшук дружини" (Одеса, 39 років)</b>

<i>Дружина клієнта (Дмитра) просто зібрала речі і поїхала у невідомому напрямку, не виходить на зв'язок.

Він хотів почати нове життя, але формально був одружений. Ми подали позов за її останньою відомою адресою прописки.

✅ <b>Результат:</b> Розлучення через 5 місяців **без її присутності та згоди.**</i>
━━━━━━━━━━━━━━━━━
"""
    ],
    
    # ЗАГАЛЬНИЙ (ГЕНДЕРНО-НЕЙТРАЛЬНИЙ)
    'default': [
        """
━━━━━━━━━━━━━━━━━
💬 <b>Кейс: "Зняття тривожності"</b>

<i>Найчастіший запит, з яким до нас приходять: "Я нічого не розумію, боюся, що це затягнеться, буде коштувати шалених грошей і я зроблю помилку".

Наша перша задача - дати клієнту **чіткий, покроковий план.**

✅ <b>Результат:</b> Це одразу знімає 90% стресу. Людина перестає боятися невідомості і бачить чіткий шлях до вирішення своєї проблеми.</i>
━━━━━━━━━━━━━━━━━
"""
    ]
}
...
def get_personalized_offer(first_name, segment_name):
    """Генерує персоналізований оффер (ПРОДАЄМО РЕЗУЛЬТАТ та ПОДВІЙНИЙ ДЕФІЦИТ)"""
...
Але для тих, хто пройшов тест, ціна — <b>всього 990 грн.</b>
Це спеціальна пропозиція **діє лише до кінця цього тижня**, і у адвоката залишилося **всього 3 слоти** для таких консультацій.
...
Наш помічник адвоката <b>зв'яжеться з вами протягом 5-15 хвилин</b>, щоб узгодити зручний час консультації.
...
async def book_consultation(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await context.bot.send_message(
        chat_id=query.message.chat_id,
        text=f"""
💡 </b>{first_name}, поки ви очікуєте дзвінок</b> (це 5-15 хв), ось чек-лист '3 головні помилки при розлученні':
